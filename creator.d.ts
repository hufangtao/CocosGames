    ...
    */
	...
	export class loader extends Pipeline {		
		...
		*/
		...
		``` 
		*/
		static loadRes(url: string, type: typeof cc.Asset | typeof cc.RawAsset, progressCallback: (completedCount: number, totalCount: number, item: any) => void, completeCallback: ((error: Error, resource: any) => void)|null): void;
		static loadRes(url: string, type: typeof cc.Asset | typeof cc.RawAsset, completeCallback: (error: Error, resource: any) => void): void;
		static loadRes(url: string, type: typeof cc.Asset | typeof cc.RawAsset): void;
