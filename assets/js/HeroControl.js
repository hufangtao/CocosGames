...
cc.Class({
    ...
    onCollisionEnter: function (other, self) {
        ...
        var tranParent = this.node.parent.getNodeToWorldTransformAR();
        var posAnchorX = this.node.width*this.node.anchorX;
        var posAnchorY = this.node.height*this.node.anchorY;
        ...
        if (cc.Intersection.rectRect(selfPreAabb, otherPreAabb)) {
            if (this.speed.y < 0 && (selfPreAabb.yMax > otherPreAabb.yMax)) {
                this.node.y = otherPreAabb.yMax - tranParent.ty+posAnchorY;
                this.jumping = false;
                this.collisionY = -1;
            }
